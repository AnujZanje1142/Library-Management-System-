...
class Lib(Tk):
    def __init__(self):
        ...
        self.a = StringVar()
        self.b = StringVar()
        self.maxsize(1300, 748)
        self.minsize(1300, 748)
        self.state("zoomed")
        self.canvas = Canvas(width=1300, height=740, bg='blue')
        self.canvas.pack()
        self.photo = PhotoImage(file='pexels-игорь-альшин-2873277.png', width=1966, height=1668)
        self.canvas.create_image(-10, -13, image=self.photo, anchor=NW)
        self.title('SILVER OAK LIBRARY MANAGEMENT SYSTEM ')
